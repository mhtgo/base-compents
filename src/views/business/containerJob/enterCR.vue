<template>
    <div>
        ...
        <base-list ref="enterCR" :condition="condition" :datas.sync="enterCR" :pageSearch="pageSearch">
            ...
            <el-table slot="list" :data="enterCR" border stripe max-height="500"
                ...
                <el-table-column prop="plateNumber" label="车牌号" sortable min-width="90"></el-table-column>
        ...
        <el-dialog title="确认弹窗" :visible.sync="pickUpDialog" :modal="false" :modal-append-to-body="false" width="400px"
                    ...
                    if (valid) {
                        ...
                        for (let i = 0; i < __arr.length; i++) {
                            _data.container.push({
                                ...
                                plateNumber: __arr[i].plateNumber,
                            })
                        }
