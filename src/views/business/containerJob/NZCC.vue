<template>
    <div>
        ...
        <base-list ref="nzcc" :condition="condition" :datas.sync="nzcc" :pageSearch="pageSearch">
            ...
            <el-table slot="list" :data="nzcc" border stripe max-height="500">
                ...
                <el-table-column prop="cargoName" label="货名" sortable min-width="75"></el-table-column>
...
<script>
    ...
    import { NZCC } from '@/api/containerJob/containerJob'
