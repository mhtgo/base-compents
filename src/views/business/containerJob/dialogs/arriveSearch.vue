<template>
    <!-- 到达确报查询 -->
    <el-dialog title="到达确报查询" :visible.sync="dialogForm" width="90%">
        ...
        <el-table slot="list" :data="contract" border stripe max-height="500" :row-class-name="tableRowClassName">
            ...
            <el-table-column prop="planJobDate" label="确报号" sortable min-width="110"> </el-table-column>

            <el-table-column prop="wagonNo" label="车皮号" sortable min-width="160"></el-table-column>

            <el-table-column prop="containerType" label="箱号" sortable min-width="160"></el-table-column>

            <el-table-column prop="containerType" label="箱型" sortable min-width="160"></el-table-column>
            ...
            <el-table-column prop="cargoWeight" label="托运人" sortable min-width="160"></el-table-column>
            <el-table-column prop="cargoWeight" label="联系电话" sortable min-width="160"></el-table-column>
            <el-table-column prop="cargoWeight" label="收货人" sortable min-width="160"></el-table-column>
            <el-table-column prop="cargoWeight" label="联系电话" sortable min-width="160"></el-table-column>
            <el-table-column prop="cargoWeight" label="接车时间" sortable min-width="160"></el-table-column>
