<template>
    <!-- 集装箱跟踪查询 -->
    <el-dialog title="集装箱跟踪" :visible.sync="dialogForm" width="90%">
        ...
        <el-table slot="list" :data="contract" border stripe max-height="500" :row-class-name="tableRowClassName">
            ...
            <el-table-column prop="planNo" label="作业类型" sortable min-width="110"> </el-table-column>

            <el-table-column prop="containerNo" label="作业时间" sortable min-width="160"></el-table-column>

            <el-table-column prop="wagonNo" label="车皮号/车牌号" sortable min-width="160"></el-table-column>

            <el-table-column prop="containerType" label="作业人员" sortable min-width="160"></el-table-column>
            ...
            <el-table-column prop="tradeType" label="内外贸" sortable min-width="160">
            <template slot-scope="scope">
                {{ scope.row.businessMode | _filterTradeType }}
            </template>
            </el-table-column>
            ...
            <el-table-column prop="cargoName" label="货名" sortable min-width="160"></el-table-column>
