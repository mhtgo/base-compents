<template>
    <div class="styleImport">
        <el-button @click="handleClick" type="primary">excel导入<i class="el-icon-upload el-icon--right"></i></el-button>
        <input type="file" class="el-upload__input" ref="upload" :accept="SheetJSFT" @change="changeFile" />
        <el-button @click="handleDownload" type="primary">模板下载<i class="el-icon-download el-icon--right"></i></el-button>
    </div>
</template>
