    ...
    export default {
        ...
        methods: {
            ...
            querySearchAsync(queryString, cb) {
                let params = {
                    search_LIKE_roleName: queryString,
            ...
            handleSelectName(item) {
                ...
                this.$emit('select', item.roleName)
                this.$emit('selectName', item.roleName)
                this.infoName = item.roleName
            }
        },
    }
</script>
