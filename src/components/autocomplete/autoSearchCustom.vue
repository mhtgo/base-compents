...
<script>
    ...
    import { getCustomList } from "@/api/custom/customList";
    ...
    export default {
        ...
        methods: {
            ...
            querySearchAsync(queryString, cb) {
                ...
                if(this.isOwner){
                    condition['search_EQ_custBusAttribute.isOwner'] = true
                }
                if(this.isCargoOwner){
                    condition['search_EQ_custBusAttribute.isCargoOwner'] = true
                }
                getCustomList(condition).then((reponse) => {
